...
DATA_DIR=/home/hernandezj45/Repos/lexidate-variation-analysis/Results/CV/Unaggregated/
mkdir -p ${DATA_DIR}

# mandatory variables
VALIDATION=unaggregated
SPLIT_OFFSET=3000
REP_OFFSET=0
...
python /home/hernandezj45/Repos/lexidate-variation-analysis/Source/cv_exp.py \
