...
training_scores = filter(training_scores, split == '75%')
...
testing_scores = filter(testing_scores, split == '75%')

# stats for 359934
# training: t > l (8.392e-05)
