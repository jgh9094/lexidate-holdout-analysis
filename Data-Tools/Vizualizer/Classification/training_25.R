...
task_1 = filter(classification_scores, task_id == c_task_id_lists[1] & split == "25%") %>%
  ggpaired(.,
           color = 'black',
           cond1 = "tournament",
           cond2 = "lexicase",
...
task_2 = filter(classification_scores, task_id == c_task_id_lists[2] & split == "25%") %>%
  ggpaired(.,
           color = 'black',
           cond1 = "tournament",
           cond2 = "lexicase",
...
task_3 = filter(classification_scores, task_id == c_task_id_lists[3] & split == "25%") %>%
  ggpaired(.,
           color = 'black',
           cond1 = "tournament",
           cond2 = "lexicase",
...
task_4 = filter(classification_scores, task_id == c_task_id_lists[4] & split == "25%") %>%
  ggpaired(.,
           color = 'black',
           cond1 = "tournament",
           cond2 = "lexicase",
