...
plot = plot_grid(
  ggdraw() + draw_label("Accuracy on test set for OpenML task 168784", fontface='bold', size = 24) + p_theme,
  test_row,
  ggdraw() + draw_label("Accuracy on selection set for OpenML task 168784", fontface='bold', size = 24) + p_theme,
  train_row,
  legend,
  nrow = 5,
...
save_plot(
  paste(filename ="task-168784.pdf"),
  plot,
  base_width=10,
  base_height=10
)
